...
<section class="reservation">
    <form class="reservationForm" method="POST" action="{{ route('dataInsert') }}">
        @csrf
        <label>typ wyjazdu
            <select class="formEl" name="typ_wyjazdu">
        ...
        <label>destynacja
            <select id="destination"  name="destination" class="formEl">
                <option value="" selected disabled></option>
        ...
        <label>zakwaterowanie
            <select class="formEl" name="zakwaterowanie">
                <option value="" selected disabled></option>
        ...
        <label>dojazd
            <select class="formEl" name="dojazd">
                <option value="" selected disabled></option>
        ...
        <label>dzieci
            <input type="number" name="children" id="children" min="0" class="formEl">
        </label>
        <label>
            <button id="submitReservation" type="submit">Wyślij</button>
        </label>
    </form>
</section>
